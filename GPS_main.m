...
for i=1:num_sate_in_eph
    ...
    aa=data_rcvr(k,3);
    pos_sate_with_dt_range(i,:)=Sate_pose(eph_para,data_rcvr(k,3));
end
...
fprintf('The user position is X:%f; Y:%f; Z:%f  ',user_pose_result(1),user_pose_result(2),user_pose_result(3));